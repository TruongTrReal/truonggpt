...
export const UserProvider = ({ children }) => {
 ...
 const fetchUserPlan = async (email) => {
    const apiUrl = 'https://ap-southeast-1.aws.data.mongodb-api.com/app/application-truonggpt-zecuw/endpoint/getplan';
    const requestData = {
      "email": email
    };
 ...
 return <UserContext.Provider value={{ user, setUser, fetchUser, fetchUserPlan, emailPasswordLogin, emailPasswordSignup, logOutUser }}>
   {children}
